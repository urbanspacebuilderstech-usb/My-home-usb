  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-gradient-to-r from-orange-600 to-orange-700 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Site Engineer Board</h1>
              <p className="text-xs text-orange-100">My Projects</p>
            </div>
          </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        {/* Header */}
        <div className="mb-8">
          <h2 data-testid="site-engineer-title" className="text-3xl font-bold text-gray-900">My Projects</h2>
          <p className="text-gray-600 mt-1">Select a project to manage materials and labour</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-gray-600">Assigned Projects</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center gap-2">
                <Building2 className="h-6 w-6 text-orange-600" />
                <span className="text-2xl font-bold text-orange-700">{projects.length}</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-gray-600">
                You haven't been assigned to any projects yet. Please contact your supervisor.
              </p>
            </CardContent>
          </Card>
        ) : (
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div className="flex items-center gap-2 text-gray-600">
                          ...
                          <span>{project.building_type || 'Building'}</span>
                        </div>
                        {project.sqft && (
                          <div className="flex items-center gap-2 text-gray-600">
                            <span className="font-medium">{project.sqft.toLocaleString()} sqft</span>
                          </div>
                        )}
                      </div>
                    </div>
