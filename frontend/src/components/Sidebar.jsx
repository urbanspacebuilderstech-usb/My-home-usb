...
export default function Sidebar({ open, onClose, user }) {
  ...
  const menuItems = [
    ...
    { name: 'CRM Sales', icon: Target, path: '/crm-sales', roles: ['super_admin', 'sales', 'sales_head', 'cre', 'accountant'] },
    { name: 'RE Projects', icon: Calculator, path: '/crm/re-projects', roles: ['super_admin', 'planning', 'general_manager', 'sales', 'sales_head'] },
    { name: 'Projects', icon: FolderKanban, path: '/projects', roles: ['super_admin', 'project_manager', 'planning', 'cre'] },
    { name: 'Add Project', icon: FolderPlus, path: '/admin/add-project', roles: ['super_admin', 'planning', 'sales', 'sales_head'] },
