...
**Live URL:** https://build-ops-3.preview.emergentagent.com
...
**Base:** `https://build-ops-3.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://build-ops-3.preview.emergentagent.com/api/projects
```
