...
**Live URL:** https://constru-hub-2.preview.emergentagent.com
...
**Base:** `https://constru-hub-2.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://constru-hub-2.preview.emergentagent.com/api/projects
```
