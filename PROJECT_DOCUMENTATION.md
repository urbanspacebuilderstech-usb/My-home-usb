...
**Live URL:** https://stage-popup.preview.emergentagent.com
...
**Base:** `https://stage-popup.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://stage-popup.preview.emergentagent.com/api/projects
```
