...
**Live URL:** https://build-crm-os.preview.emergentagent.com
...
**Base:** `https://build-crm-os.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://build-crm-os.preview.emergentagent.com/api/projects
```
