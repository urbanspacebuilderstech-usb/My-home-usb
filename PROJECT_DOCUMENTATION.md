...
**Live URL:** https://construction-crm-6.preview.emergentagent.com
...
**Base:** `https://construction-crm-6.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://construction-crm-6.preview.emergentagent.com/api/projects
```
