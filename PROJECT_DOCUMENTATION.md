...
**Live URL:** https://project-payment-mgmt.preview.emergentagent.com
...
**Base:** `https://project-payment-mgmt.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://project-payment-mgmt.preview.emergentagent.com/api/projects
```
