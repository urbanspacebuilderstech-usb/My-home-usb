...
**Live URL:** https://e2e-vinoth-test.preview.emergentagent.com
...
**Base:** `https://e2e-vinoth-test.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://e2e-vinoth-test.preview.emergentagent.com/api/projects
```
