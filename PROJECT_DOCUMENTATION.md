...
**Live URL:** https://construction-control.preview.emergentagent.com
...
**Base:** `https://construction-control.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://construction-control.preview.emergentagent.com/api/projects
```
