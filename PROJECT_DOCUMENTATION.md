...
**Live URL:** https://cre-board.preview.emergentagent.com
...
**Base:** `https://cre-board.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://cre-board.preview.emergentagent.com/api/projects
```
