...
**Live URL:** https://construct-crm-3.preview.emergentagent.com
...
**Base:** `https://construct-crm-3.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://construct-crm-3.preview.emergentagent.com/api/projects
```
