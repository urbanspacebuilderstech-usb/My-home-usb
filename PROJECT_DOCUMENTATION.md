...
**Live URL:** https://project-manager-hub-5.preview.emergentagent.com
...
**Base:** `https://project-manager-hub-5.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://project-manager-hub-5.preview.emergentagent.com/api/projects
```
