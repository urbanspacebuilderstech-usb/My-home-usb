...
**Live URL:** https://crew-manage-1.preview.emergentagent.com
...
**Base:** `https://crew-manage-1.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://crew-manage-1.preview.emergentagent.com/api/projects
```
