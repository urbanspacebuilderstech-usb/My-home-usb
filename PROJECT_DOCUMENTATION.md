...
**Live URL:** https://site-accounting-2.preview.emergentagent.com
...
**Base:** `https://site-accounting-2.preview.emergentagent.com/api`
...
curl -H "Authorization: Bearer <token>" \
  https://site-accounting-2.preview.emergentagent.com/api/projects
```
